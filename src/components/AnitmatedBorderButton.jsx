...
export const AnimatedBoarderButton = () => {
  return (
    ...
    disabled:opacity-50 disabled:cursor-not-allowed group px-8 py-4 text-lg font-medium rounded-full overflow-visible animate-border">
